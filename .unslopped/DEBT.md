...
- [soon] about.json and flood-control-projects.json locale namespaces still carry BetterGov.ph titles and bettergov.ph emails in en, fil, ceb, krj (public/locales) :: logged 2026-09-04, cycle 20260904-b848b4
- [cleanup] Five routes in seo-metadata.json read about BetterKananga through BetterKananga, awkward copy carried over from upstream; most sit on national pages headed for pruning (src/data/seo-metadata.json) :: logged 2026-09-04, cycle 20260904-d930dc
- [soon] Community and upstream body copy still says BetterGov in about, contribute, Discord, sitemap, travel print and websites pages plus navbar links to about.bettergov.ph; rewrite or prune with the national content (src/pages) :: logged 2026-09-05, cycle 20260904-beac4f
- [pattern] Global SEO in App.tsx and page level head tags render duplicate description and og metas under React 19 native hoisting; first occurrence wins for scrapers. Pick one owner per tag (src/components/SEO.tsx) :: logged 2026-09-05, cycle 20260904-beac4f
